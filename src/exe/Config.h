...
enum Language {
	...
	// Only supported by freetranslations, and I don't know its url for them.
	LANGUAGE_Hausa,
	LANGUAGE_Pashto,
	LANGUAGE_Somali,
	LANGUAGE_Urdu,
...
int LoadInjectionSettings(InjectionSettings &cfg, wchar_t *name, wchar_t *path, wchar_t **internalHooks);
int SaveInjectionSettings(InjectionSettings &cfg, wchar_t *name, wchar_t *internalHooks);
