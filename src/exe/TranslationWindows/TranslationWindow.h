...
public:
	...
	void Translate(SharedString *orig, SharedString *&mod);
	virtual void Translate(SharedString *text) {}
	...
	inline virtual int CanTranslate(Language src, Language dst) {return 0;}
